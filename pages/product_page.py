...
class ProductPage(BasePage):
    def add_product_to_basket(self):
        ...
        basket_value = self.find(
            ProductPageLocators.product_page_total_basket_value).text
        ...
        assert str(price_product_float + present_value_float) in basket_value, \
            f"The product price is not equal to the basket price {price_product_float} +\
                {present_value_float} != {basket_value}"
