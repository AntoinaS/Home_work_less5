...
@pytest.fixture
def open_user_product_page(browser):
    open_main_page = MainPage(browser)
    open_main_page.open_page()
    auth_page = open_main_page.go_to_auth_page()
    open_user_product_page = auth_page.enter_data_and_go_to_LK()
    return open_user_product_page
...
'''def test_user_can_add_product_to_basket(browser, open_user_product_page):
    return True
    #open_user_product_page.add_product_to_basket()'''
